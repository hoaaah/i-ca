                    ...
                    ['label' => 'Penatausahaan', 'icon' => 'chevron-circle-right', 'url' => '#', 'visible' => !Yii::$app->user->isGuest, 'items' => 
                        [
                            ...
                            ['label' => 'Cost Sheet/SPD', 'icon' => 'circle-o', /*'visible' => in_array(511, $menus) || in_array(512, $menus),*/ 'items'=> [
                                ['label' => 'Input Usulan', 'icon' => 'circle-o', 'url' => ['/spd/usulan'], /*'visible' => in_array(511, $menus)*/ ],
                                ['label' => 'Persetujuan Proglap', 'icon' => 'circle-o', 'url' => ['/spd/p3a'], /*'visible' => in_array(511, $menus)*/ ],
                                ['label' => 'Reviu Keuangan', 'icon' => 'circle-o', 'url' => ['/spd/reviukeu'], /*'visible' => in_array(511, $menus)*/ ],
                                ['label' => 'Reviu TU', 'icon' => 'circle-o', 'url' => ['/spd/reviutu'], /*'visible' => in_array(511, $menus)*/ ],
                                ['label' => 'Persetujuan Ka. Unit', 'icon' => 'circle-o', 'url' => ['/spd/kaunit'], /*'visible' => in_array(511, $menus)*/ ],
                                ['label' => 'Proses SPD', 'icon' => 'circle-o', 'url' => ['/spd/prosesspd'], /*'visible' => in_array(511, $menus)*/ ],
                                ['label' => 'Anggaran UM', 'icon' => 'circle-o', 'url' => ['/spd/anggaranum'], /*'visible' => in_array(511, $menus)*/ ],
                            ]],
                        ],
                    ], 
