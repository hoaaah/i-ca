...
/**
 * This is the model class for table "ta_unit_jab".
 *
 ...
 */
class TaUnitJab extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['tahun', 'unit_id', 'kd_jabatan', 'no_jabatan'], 'required'],
            [['tahun'], 'safe'],
            [['unit_id', 'kd_jabatan', 'no_jabatan'], 'integer'],
            [['nama'], 'string', 'max' => 50],
            [['nip'], 'string', 'max' => 21],
