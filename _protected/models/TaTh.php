...
class TaTh extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            [['tahun'], 'safe'],
            [['set_1', 'set_2', 'set_3', 'set_4', 'set_5', 'set_6', 'set_7', 'set_8', 'set_9', 'set_10', 'set_11', 'set_12', 'set_13', 'set_14', 'set_15'], 'string', 'max' => 255],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'set_4' => Yii::t('app', 'Kelurahan Dinkes'),
            'set_5' => Yii::t('app', 'Alamat Dinkes'),
            ...
            'set_11' => Yii::t('app', 'Nama Dinas Pengelola Kesehatan'),
            'set_12' => Yii::t('app', 'Nama Dinas Pengelola Keuangan'),
            'set_13' => Yii::t('app', 'Kunci Sumber Belanja'),
            'set_14' => Yii::t('app', 'Set 14'),
            'set_15' => Yii::t('app', 'Set 15'),
        ];
    }
